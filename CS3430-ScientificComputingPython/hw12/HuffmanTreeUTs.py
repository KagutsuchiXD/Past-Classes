...
# my debugging traces are given as comments right before some
# tests.
...
============ Huffman Tree  UT 1 passed ==============
    ...
    def test_ht_ut01(self, tn=1):
        ...
        print('****Original List****')
        HuffmanTree.displayListOfNodes(hnodes)
...
'''
    ...
    def test_ht_ut03(self, tn=3):
        print('\n============ Huffman Tree UT {} ======================='.format(tn))
        # Let's build the Huffman Tree from Ch. 2 in "Structure and Interpretation of Computer Programs"
        # manually and bottom up.
        ...
        CDEF_4 = HuffmanTree.mergeTwoNodes(CD_2, EF_2)
        ### Merging B_3 and CD_2
        BGH_5 = HuffmanTree.mergeTwoNodes(B_3, GH_2)
        ### Merging BCD_5 and EFGH_4
        BCDEFGH_9 = HuffmanTree.mergeTwoNodes(BGH_5, CDEF_4)
        ...
        HuffmanTree.displayHuffmanTree(alt_ht)
        assert alt_ht is not None
        print('SCIP Huffman Tree Encodings:')
        for ch, _ in HuffmanTreeUTs.char_freqs02:
            print('encode({}) = {}'.format(ch, scip_ht.encodeSymbol(ch)))
        print('Alternative Huffman Tree Encodings:')
        for ch, _ in HuffmanTreeUTs.char_freqs02:
...
============ Huffman Tree  UT 4 passed ==============
    ...
    def test_ht_ut04(self, tn=4):
        print('\n============ Huffman Tree UT {} ======================='.format(tn))
        ### Let's again build the Huffman Tree from Ch. 2 in "Structure and Interpretation of Computer Programs"
        ### manually and bottom up.
        A_8 = HuffmanTreeNode(symbols=set(['A']), weight=8)
        B_3 = HuffmanTreeNode(symbols=set(['B']), weight=3)
        C_1 = HuffmanTreeNode(symbols=set(['C']), weight=1)
        ...
        txt0 = 'AABCCDEFG'
        txt1 = 'AABBBBHHHFFGGGDDDDEEEECCCCCCCCDDDDDHHHHHAAAAAA'
        ### Let's test the encode/decode equations on slide 23 in
        ### cs3430_s20_lec23_huffman.pdf (Lecture 23 on Canvas).
