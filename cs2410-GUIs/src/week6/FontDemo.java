...
public class FontDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Font fnt1 = new Font("Comic Sans",20);
        label.setFont(Font.font("Times New Roman", FontWeight.THIN, FontPosture.ITALIC, 35));

        //overwriting font for label, with fnt1
        //label.setFont(fnt1);
