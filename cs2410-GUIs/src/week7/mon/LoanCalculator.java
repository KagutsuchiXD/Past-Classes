...
//Show Lamba call another function

//3. Write SimpleCalculator.java
...
public class LoanCalculator extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        gridPane.setHgap(5);
        gridPane.setVgap(5);
        lbAnnIntRate = new Label("Annual Interest Rate: ");
        gridPane.add(lbAnnIntRate, 0, 0);
    ...
    private void calculateLoanPayment() {
        ...
        message.setText("Thank you for getting a loan with us!!");
    }
